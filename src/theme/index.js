...
const MyColors = {
  /* CSS HEX */
  magnolia: '#F4F4FF', // '#F4F4FF',  Light background
  blue_green: '#4361EE', // '#219EBC',  Very light blue
  sapphire_blue: '#560BAD', // '#046B9F',  Light blue
  independence: '#21075F', // '#42526E',  Grey blue
  space_cadet: '#480CA8', // '#172B4D',  dark blue
  orange: '#FFC9B9', // '#FB8500',  organge
  tart_orange: '#F44336', // same (red)
  green_pantone: '#4CAF50', // same (green)
  white: '#FFFFFF', // same (white)
  black: '#000000', // same (black)
};
